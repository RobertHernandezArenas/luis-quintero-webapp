<template>
  <form id="contact" class="contact" action="https://formsubmit.co/roberthernandezarenas@gmail.com" method="POST">
    <h2 class="contact__title">CONTACT US</h2>

    <div class="contact__form">
      <input id="name" name="name" class="contact__form-input" type="text" placeholder=" " autocomplete="off"
        required />
      <label for="name" class="contact__form-label">Nombre Completo</label>
    </div>

    <div class="contact__form">
      <input id="email" name="email" class="contact__form-input" type="email" placeholder=" " autocomplete="off"
        required />
      <label for="name" class="contact__form-label">Email</label>
    </div>

    <div class="contact__form">
      <input id="subject" name="subject" class="contact__form-input" type="text" placeholder=" " autocomplete="off"
        required />
    ...
    <div class="contact__form">
      ...
      <textarea class="contact__form-txt-area" id="message" name="message"></textarea>
